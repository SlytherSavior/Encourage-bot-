...
client.on("message", msg => {
  if(msg.author.bot) return
  if(msg.content === "$help") {
    msg.reply("***Thanks for getting this bot . Its just a simple bot developed by Slytherr . I give inspiring quotes to you.                        Commands - $help, /n $yt,$inspire,$i am sad .  Note : The bot is still in development.***")
  }
})
client.on("message", msg => {
